...
//-------------------------------------------------------------------------------------------------------------------------------------------------
#define HUD_STATUS_FONT			[UIFont boldSystemFontOfSize:17]
#define HUD_STATUS_COLOR		[[UIColor blackColor] colorWithAlphaComponent:0.85]

#define HUD_SPINNER_COLOR		[UIColor blackColor]
#define HUD_BACKGROUND_COLOR	[UIColor colorWithWhite:0.0 alpha:0.25]
#define HUD_WINDOW_COLOR		[UIColor colorWithWhite:0.0 alpha:0.25]
